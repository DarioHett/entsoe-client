...
production['GenerationType'] = production['TimeSeries.MktPSRType.psrType']. \
    apply(lambda x: ParameterTypes.PsrType[x].value) # Use ParameterTypes to transform ENTSO-E Code into readable string.
...
plot_params = dict(stacked=True, grid=True, legend=True, cmap='tab20c', width=1., rot=15, ec='lightgrey')
